ALTER TABLE "transcations" RENAME TO "transactions";--> statement-breakpoint
ALTER TABLE "transactions" DROP CONSTRAINT "transcations_account_id_accounts_id_fk";
--> statement-breakpoint
ALTER TABLE "transactions" DROP CONSTRAINT "transcations_category_id_categories_id_fk";
--> statement-breakpoint
DO $$ BEGIN
